...
[![进程1](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/1.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/1.png)
...
[![进程关系](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/2.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/2.png)
...
[![进程关系](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/3.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/3.png)
...
[![浏览器容错性](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/4.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/4.png)
...
- site-instance
  ...
  connected pages from the same site
  ...
  can obtain references to each other in script code

   

  怎么理解这段话呢。满足下面两中情况并且打开的新页面和旧页面属于上面定义的同一个 site，就属于同一个
...
[![浏览器进程线程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/5.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/5.png)

#### 第一步：处理输入

当我们在浏览器的地址栏输入内容按下回车时，`UI thread`会判断输入的内容是搜索关键词（search query）还是URL，如果是搜索关键词，跳转至默认搜索引擎对应都搜索URL，如果输入的内容是URL，则开始请求URL。

[![处理输入](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/6.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/6.png)
...
[![开始导航](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/7.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/7.png)
...
[![查找渲染进程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/8.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/8.png)
...
[![提交导航](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/9.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/9.png)
...
[![浏览器进程中线程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/10.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/10.png)
...
[![加载子资源](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/11.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/11.png)

#### JavaScript的下载与执行

构建DOM过程中，如果遇到``标签，渲染引擎会停止对HTML的解析，而去加载执行JS代码，原因在于JS代码可能会改变DOM的结构（比如执行`document.write()`等API）

不过开发者其实也有多种方式来告知浏览器应对如何应对某个资源，比如说如果在`` 标签上添加了 `async` 或 `defer` 等属性，浏览器会异步的加载和执行JS代码，而不会阻塞渲染。

#### 样式计算 - Style calculation

DOM树只是我们页面的结构，我们要知道页面长什么样子，我们还需要知道DOM的每一个节点的样式。主线程在解析页面时，遇到``标签或者``标签的CSS资源，会加载CSS代码，根据CSS代码确定每个DOM节点的计算样式（computed style）。

计算样式是主线程根据CSS样式选择器（CSS selectors）计算出的每个DOM元素应该具备的具体样式，即使你的页面没有设置任何自定义的样式，浏览器也会提供其默认的样式。

[![样式计算](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/12.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/12.png)
...
[![layout](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/13.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/13.png)
...
[![paint](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/14.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/14.png)
...
[![最简单的光栅化过程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/15.gif)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/15.gif)
...
[![合成的光栅化过程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/16.gif)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/16.gif)
...
[![layer tree](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/17.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/17.png)
...
[![光栅线程创建图块的位图并发送给GPU](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/18.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/18.png)
...
[![合成线程构建出合成帧，合成帧会被发送给浏览器进程然后再发送给GPU](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/19.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/19.png)
...
[![点击事件从浏览器进程路由到渲染进程](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/20.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/20.png)
...
[![非快速滚动区域有用户事件发生](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/21.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/21.png)
...
[![当整个页面都是非快速滚动区域时页面的事件处理示意图](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/22.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/22.png)
...
[![当整个页面都是非快速滚动区域时页面的事件处理示意图](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/23.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/23.png)
...
[![事件淹没了屏幕刷新的时间轴，导致页面很卡顿](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/24.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/24.png)

出于优化的目的，浏览器会合并这些连续的事件，延迟到下一帧渲染是执行，也就是`requestAnimationFrame`之前。

[![和之前相同的事件轴，可是这次事件被合并并延迟调度了](https://raw.githubusercontent.com/yacan8/blog/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86/25.png)](https://raw.githubusercontent.com/yacan8/blog/master/images/浏览器工作原理/25.png)
