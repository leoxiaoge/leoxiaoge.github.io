...
#### [#](http://obkoro1.com/web_accumulate/accumulate/JS/JS基础-继承.html#原型链继承的缺点)原型链继承的缺点
...
#### [#](http://obkoro1.com/web_accumulate/accumulate/JS/JS基础-继承.html#constructor的应用场景：)`constructor`的应用场景：
